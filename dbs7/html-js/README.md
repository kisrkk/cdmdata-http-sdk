# HTML / Browser JS (legacy / dbs7)

ใช้ `fetch` ของ browser ล้วนๆ ไม่มี library, ไม่มี build step ใช้กับ [legacy API](../../../(legacy)cdmdata-public-api.md)
(`cust_id`, ไฟฟ้า/น้ำ, `dbs7.cplservice.com`) — ถ้าต้องการ API รุ่นใหม่ (`device_id`) ดูที่ [`../../dbs5/html-js`](../../dbs5/html-js)
...
แล้วกรอก AK/SK/cust_id ในฟอร์ม
